...
const data = [
...

    {
        ...
        website: "https://crypto-dev-whitelist-frontend.vercel.app/"
    },
        
    {
        ...
        github: "https://github.com/LegatoReign/CryptoDev_dApp",
        website: "https://crypto-dev-nft-collection-frontend-4fb9.vercel.app/"
    },
                   ...
                   data.map(({id, image, title, github, demo}) => {
                       return (
                        ...
                        <div className="portfolio__item-cta">
                            ...
                            <a href={demo} target="_blank" rel="noreferrer" className="btn btn-primary btn-1">Site</a>
                        </div>
                    </article>
                       )
                   })
